...
# top-5 shortlist and persist results. Local (not a cloud Routine) because
...
PROJECT_DIR="/Users/nikhilkumar/Desktop/Projects/Fintrixa"
...
1. cd backend && .venv/bin/python scripts/get_shortlist.py -- this prints the top-5 shortlist as JSON.
